...
<<<<<<< HEAD
-- (объясните смысл типовой аннотации: функция double, у которой 1 параметр типа "a" и результат типа "a", где "a" принадлежит классу типов Num)
=======
...
dayOfWeek 7 = "Sunday"
dayOfWeek _ = error "There is no day for this digit"
